...
from text_to_speech_program.about import (
    __version__,
    __package__,
    __program_server__,
    __program_client__,
...
[project.scripts]
"{__program_server__}" = "{__package__}.server:main"
"{__program_client__}" = "{__package__}.client:main"

[tool.setuptools.package-data]
"{__package__}" = ["icons/text_to_speech_program.png"]
"""
